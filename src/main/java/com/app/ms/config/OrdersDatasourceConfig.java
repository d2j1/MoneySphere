...
@Configuration
@EnableJpaRepositories(basePackages ="com.app.ms.orders.repository", entityManagerFactoryRef = "ordersEntityManagerFactory", 
...
public class OrdersDatasourceConfig {
	...
	public LocalContainerEntityManagerFactoryBean ordersEntityManagerFactory() {
		...
		factory.setPackagesToScan(new String[] { "com.app.ms.orders.entity" });
	...
	@Bean
	public DataSourceInitializer ordersDataSourceInitilizer() {
